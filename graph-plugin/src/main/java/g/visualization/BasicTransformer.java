...
import g.visualization.transform.MutableAffineTransformer;
...
public class BasicTransformer implements MultiLayerTransformer, 
    ...
    /**
	 * @see g.visualization.MultiLayerTransformer#setViewTransformer(g.visualization.transform.MutableTransformer)
	 */
