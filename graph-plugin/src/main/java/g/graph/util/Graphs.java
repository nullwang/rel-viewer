package g.graph.util;

import java.io.Serializable;
import java.util.Collection;

import g.graph.DirectedGraph;
import g.graph.Forest;
import g.graph.Graph;
import g.graph.Tree;
import g.graph.UndirectedGraph;
/**
...
public class Graphs {
	...
	static abstract class SynchronizedAbstractGraph<V,E> implements Graph<V,E>, Serializable {
		...
		/**
		 * @see g.graph.Graph#addEdge(Object, Object, Object, EdgeType)
		 */
        ...
        /**
         * @see g.graph.Hypergraph#addEdge(Object, Collection, EdgeType)
         */
		...
		/**
		 * @see g.graph.Graph#addEdge(Object, Object, Object)
		 */
		...
		/**
		 * @see g.graph.Graph#getEdges(EdgeType)
		 */
		...
		/**
		 * @see g.graph.Hypergraph#getIncidentCount(Object)
		 */
	...
	static abstract class UnmodifiableAbstractGraph<V,E> implements Graph<V,E>, Serializable {
        ...
        /**
         * @see g.graph.Graph#addEdge(Object, Collection, EdgeType)
         */
		...
		/**
		 * @see g.graph.Graph#getEdges(edu.uci.ics.jung.graph.util.EdgeType)
		 */
