...
public abstract class LayoutDecorator<V, E> implements Layout<V, E>, IterativeContext {
    ...
    /**
     * @see g.algorithms.layout.Layout#transform(Object)
     */
    ...
    /**
     * @see g.algorithms.layout.Layout#lock(Object, boolean)
     */
    ...
    /**
     * @see g.algorithms.layout.Layout#isLocked(Object)
     */
    ...
    /**
     * @see g.algorithms.layout.Layout#setSize(Dimension)
     */
