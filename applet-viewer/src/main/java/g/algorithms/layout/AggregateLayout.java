...
public class AggregateLayout<V, E> implements Layout<V,E>, IterativeContext {
	 ...
	 * @see g.algorithms.layout.Layout#getGraph()
	 */
	 ...
	 * @see g.algorithms.layout.Layout#getSize()
	 */
	 ...
	 * @see g.algorithms.layout.Layout#isLocked(java.lang.Object)
	 */
	 ...
	 * @param v
	 * @param state
	 * @see g.algorithms.layout.Layout#lock(java.lang.Object, boolean)
	 */
	...
	/**
	 * 
	 * @see g.algorithms.layout.Layout#reset()
	 */
	public void reset() {
		for(Layout<V,E> layout : layouts.keySet()) {
			layout.reset();
	...
	/**
	 * @param graph
	 * @see g.algorithms.layout.Layout#setGraph(g.graph.Graph)
	 */
	...
	/**
	 * @param initializer
	 * @see g.algorithms.layout.Layout#setInitializer(o.c15.Transformer)
	 */
	...
	/**
	 * @param d
	 * @see g.algorithms.layout.Layout#setSize(java.awt.Dimension)
	 */
	 ...
	 * @see o.c15.Transformer#transform(java.lang.Object)
	 */
